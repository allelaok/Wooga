...
// End Cross Module References
...
#endif
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_FX;
#if WITH_METADATA
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_smokeFactory_MetaData[];
#endif
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_smokeFactory;
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFirePosition_Statics::NewProp_FX_MetaData[] = {
		{ "Category", "FX" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/FirePosition.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AFirePosition_Statics::NewProp_FX = { "FX", nullptr, (EPropertyFlags)0x0010000000080009, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AFirePosition, FX), Z_Construct_UClass_UParticleSystemComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AFirePosition_Statics::NewProp_FX_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AFirePosition_Statics::NewProp_FX_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFirePosition_Statics::NewProp_smokeFactory_MetaData[] = {
		{ "Category", "Fire" },
		{ "ModuleRelativePath", "Public/FirePosition.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AFirePosition_Statics::NewProp_smokeFactory = { "smokeFactory", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AFirePosition, smokeFactory), Z_Construct_UClass_UParticleSystem_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AFirePosition_Statics::NewProp_smokeFactory_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AFirePosition_Statics::NewProp_smokeFactory_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AFirePosition_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFirePosition_Statics::NewProp_FX,
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFirePosition_Statics::NewProp_smokeFactory,
	...
	IMPLEMENT_CLASS(AFirePosition, 3680251903);
