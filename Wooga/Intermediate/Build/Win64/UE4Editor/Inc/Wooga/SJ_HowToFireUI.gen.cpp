...
// End Cross Module References
...
#endif
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_howToFireImg_MetaData[];
#endif
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_howToFireImg;
#if WITH_METADATA
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USJ_HowToFireUI_Statics::NewProp_howToFireImg_MetaData[] = {
		{ "BindWidget", "" },
		{ "Category", "Image" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/SJ_HowToFireUI.h" },
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_USJ_HowToFireUI_Statics::NewProp_howToFireImg = { "howToFireImg", nullptr, (EPropertyFlags)0x001000000009000d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USJ_HowToFireUI, howToFireImg), Z_Construct_UClass_UImage_NoRegister, METADATA_PARAMS(Z_Construct_UClass_USJ_HowToFireUI_Statics::NewProp_howToFireImg_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USJ_HowToFireUI_Statics::NewProp_howToFireImg_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_USJ_HowToFireUI_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_USJ_HowToFireUI_Statics::NewProp_howToFireImg,
	...
	IMPLEMENT_CLASS(USJ_HowToFireUI, 3477995912);
