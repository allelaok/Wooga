...
// End Cross Module References
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_fireRock2_MetaData[];
#endif
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_fireRock2;
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFireRock_Statics::NewProp_currentTime_MetaData[] = {
		{ "ModuleRelativePath", "Public/FireRock.h" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AFireRock_Statics::NewProp_currentTime = { "currentTime", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AFireRock, currentTime), METADATA_PARAMS(Z_Construct_UClass_AFireRock_Statics::NewProp_currentTime_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AFireRock_Statics::NewProp_currentTime_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFireRock_Statics::NewProp_fireRock2_MetaData[] = {
		{ "ModuleRelativePath", "Public/FireRock.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AFireRock_Statics::NewProp_fireRock2 = { "fireRock2", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AFireRock, fireRock2), Z_Construct_UClass_AFireRock2_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AFireRock_Statics::NewProp_fireRock2_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AFireRock_Statics::NewProp_fireRock2_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AFireRock_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFireRock_Statics::NewProp_currentTime,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFireRock_Statics::NewProp_me,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFireRock_Statics::NewProp_fireRock2,
	...
	IMPLEMENT_CLASS(AFireRock, 3569904558);
