...
// End Cross Module References
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_topLoc_MetaData[];
#endif
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_topLoc;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_midLoc_MetaData[];
#endif
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_midLoc;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bottomLoc_MetaData[];
#endif
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_bottomLoc;
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AStem_Statics::NewProp_topLoc_MetaData[] = {
		{ "Category", "Setting" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/Stem.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AStem_Statics::NewProp_topLoc = { "topLoc", nullptr, (EPropertyFlags)0x001000000008000d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AStem, topLoc), Z_Construct_UClass_UStaticMeshComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AStem_Statics::NewProp_topLoc_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AStem_Statics::NewProp_topLoc_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AStem_Statics::NewProp_midLoc_MetaData[] = {
		{ "Category", "Setting" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/Stem.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AStem_Statics::NewProp_midLoc = { "midLoc", nullptr, (EPropertyFlags)0x001000000008000d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AStem, midLoc), Z_Construct_UClass_UStaticMeshComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AStem_Statics::NewProp_midLoc_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AStem_Statics::NewProp_midLoc_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AStem_Statics::NewProp_bottomLoc_MetaData[] = {
		{ "Category", "Setting" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/Stem.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AStem_Statics::NewProp_bottomLoc = { "bottomLoc", nullptr, (EPropertyFlags)0x001000000008000d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AStem, bottomLoc), Z_Construct_UClass_UStaticMeshComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AStem_Statics::NewProp_bottomLoc_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AStem_Statics::NewProp_bottomLoc_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AStem_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AStem_Statics::NewProp_topLoc,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AStem_Statics::NewProp_midLoc,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AStem_Statics::NewProp_bottomLoc,
	...
	IMPLEMENT_CLASS(AStem, 3241955776);
